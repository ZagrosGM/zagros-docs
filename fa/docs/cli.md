...
| `update [--version <tag>]` | پشتیبان ← کشیدن ← migration ← سلامت، با بازگشتِ خودکار؛ تا وقتی نسخه‌ای پین نشده، تگِ `latest` ایمیج را دنبال می‌کند |
...
| `version` | نسخهٔ CLI، تگِ ایمیج (و نسخه‌ای که پشتِ `latest` است)، پنل و جدیدترین انتشار |
| `help` | راهنما |
