...
| "Online now" looks too high | It counts activity in the last 90 seconds, not "connected and idle" | For Xray, online means *counters grew since the last sample* — an idle client is not online |
